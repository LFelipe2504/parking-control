...
public class ParkingSpotController {
	...
	public ResponseEntity<Object> updateParkingSpot(@PathVariable (value = "id") UUID id,
		...
		Optional<ParkingSpotModel> parkinSpotModelOptional = parkingSpotService.findById(id);
		if(!parkinSpotModelOptional.isPresent()) {
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Parking Spot not found.") ;
		}
		BeanUtils.copyProperties(parkingSpotDto, parkinSpotModelOptional.get());
		parkingSpotService.save(parkinSpotModelOptional.get());  
